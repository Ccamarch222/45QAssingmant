...
shouldtake in an artist name and an album title, and it should return a Object containing these 
...
Print each return value to show that Objects are storing the album information correctly. Add an optional
 ...
 includes a value for the number of tracks, add that value to the album’s Object. Make at least one new
  ...
  console.log(album1);
  let album2 = make_album("Ed Sheeran", "Equals");
  console.log(album2);
  let album3 = make_album(`shuga`, `august`, 13);
  console.log(album3);
